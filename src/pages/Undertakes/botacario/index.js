    ...
    if (!fontsLoaded) {
        ...
        return (
            <LinearGradient colors={['#ffffff', '#A895C3',]}
                ...
                <Text style={font.subTittlePage}>Nome: Boticario</Text>
                    <Text style={font.subTittlePage}>Site:www.grupoboticario.com.br</Text>
                    
                    <Text style={font.subTittlePage}>Tamanho: Mais de 10.000 funcionários e mais de 70mil colaboradores</Text>
                    
                    <Text style={font.subTittlePage}>Tipo: Empresa privada</Text>
                    <Text style={font.subTittlePage}>Setor: Lojas de artigos pessoais e de beleza</Text>
