        ...
        return (
            <LinearGradient colors={['#ffffff', '#A895C3',]}
                ...
                <ScrollView>
                    ...
                    <Text style={font.subTittlePage}>Nome: Carrefour</Text>
                    <Text style={font.subTittlePage}>Site:www.carrefour.com.br</Text>

                    <Text style={font.subTittlePage}>Tamanho: Mais de 10.000 funcionários</Text>
                    <Text style={font.subTittlePage}>Fundação:1958</Text>
                    <Text style={font.subTittlePage}>Tipo: Empresa privada</Text>
                    <Text style={font.subTittlePage}>Setor: Lojas de artigos gerais e grandes lojas</Text>
